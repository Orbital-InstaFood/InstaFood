    ...
    return (
        isSaved ? (
            <div>
                ...
                onClick={() => saveOrUnsaveAPost(postID, false)}>You saved this post. Remove from your collection?</button>
            </div>
        ) : (
            <div>
                <button 
                className="save-button"
                onClick={() => saveOrUnsaveAPost(postID, true)}>Save this post to your collection?</button>
            </div>
        )
    );
}
